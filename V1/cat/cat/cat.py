...
class Kedi:
    def __init__(self, x, y, screen_width, screen_height, ev):
        ...
        # Resimleri yükle ve boyutlandır (bu kısmı __init__ içine taşıdım)
        ...
        self.animasyonlar.guncel_resim = self.oturma_resimleri[0]
        self.rect = self.animasyonlar.guncel_resim.get_rect(topleft=(x, y))
